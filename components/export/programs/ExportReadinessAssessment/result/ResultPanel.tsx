...
import ReadinessGauge from "./ReadinessGuage";
...
export default function ResultsPanel({
  ...
  const readinessKeyMap: Record<string, string> = {
    "Emerging Exporter": "readiness_not_ready",
    "Developing Exporter": "readiness_developing",
    "Export Ready": "readiness_export_ready",
    "Global Market Ready": "readiness_market_entry_ready",
  };
  ...
  return (
    <>
      ...
      <div>
        <RecommendedNextSteps tier={result.readinessTier} />
      </div>
    </>
  );
}