...
export default function FoodCastHero() {
  const t = useTranslations("foodcast.hero")
    ...
    <section className="surface-dark py-24">
      <div className="max-w-7xl mx-auto px-6 lg:grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="surface p-8 rounded-xl shadow-xl text-center">
          <p className="text-sm text-muted mb-2">{t("episodesLabel")}</p>
          <p className="font-semibold text-secondary">{t("episodesCount")}</p>
        </div>
