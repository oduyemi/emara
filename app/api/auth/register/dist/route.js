    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 2:
                    _b = _c.sent(), fname = _b.fname, lname = _b.lname, email = _b.email, password = _b.password, role = _b.role;
                    if (!fname || !lname || !email || !password) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: "All fields required" }, { status: 400 })];
                    }
