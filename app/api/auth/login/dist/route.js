...
function POST(req) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, email, password, user, isMatch, token, res, error_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 5:
                    _b.sent();
                    token = jsonwebtoken_1["default"].sign({ id: user._id.toString(), role: user.role }, process.env.JWT_SECRET, { expiresIn: "7d" });
