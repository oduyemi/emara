...
function POST(req) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var cookieStore, token, decoded, body, step, data, updateData, normalizePlan, profile, error_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 3:
                    ...
                    return [4 /*yield*/, supplierProfile_model_1.SupplierProfile.findOneAndUpdate({ user: decoded.userId }, { $set: updateData }, { "new": true, upsert: true })];
                case 4:
                    profile = _b.sent();
