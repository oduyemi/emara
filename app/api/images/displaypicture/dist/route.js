...
function POST(req) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var cookieStore, token, decoded, formData, file, bytes, buffer_1, uniqueFileName_1, uploadResult, updatedUser, error_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 4:
                    ...
                    uniqueFileName_1 = "dp_" + decoded.userId + "_" + Date.now();
                ...
                case 5:
                    ...
                    return [4 /*yield*/, user_model_1["default"].findByIdAndUpdate(decoded.userId, { image: uploadResult.secure_url }, { "new": true }).select("_id fname lname email image")];
                case 6:
                    updatedUser = _b.sent();
